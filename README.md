...
| `components/`  | The actual on-screen UI: the sign-in screen, the repository-setup screen, the tree browser and its edit/rename/move/delete controls, search, history/restore, and export.                                                                                                                                                   |
